	...
	<main>
			...
			<div id="rev_slider_54_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.4.1">
				<ul>
					...
					<li data-index="rs-141" data-transition="fadetotopfadefrombottom" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="Power3.easeInOut" data-easeout="Power3.easeInOut" data-masterspeed="1500" data-thumb="rev-slider-files/assets/100x50_notgeneric_bg5.jpg" data-rotate="0" data-saveperformance="off" data-title="Chill" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
						<!-- MAIN IMAGE -->
						<img src="img/new/slider2-masjid-agung.jpg" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
						<!-- LAYERS -->

						<!-- LAYER NR. 6 -->
						<div class="tp-caption NotGeneric-Title   tp-resizeme rs-parallaxlevel-3" id="slide-141-layer-1" data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']" data-y="['middle','middle','middle','middle']" data-voffset="['0','0','0','0']" data-fontsize="['50','46','36','28']" data-lineheight="['46','46','36','28']" data-width="none" data-height="none" data-whitespace="nowrap" data-type="text" data-responsive_offset="on" data-frames='[{"delay":1000,"split":"chars","split_direction":"forward","splitdelay":0.05,"speed":2000,"frame":"0","from":"y:[100%];z:0;rZ:-35deg;sX:1;sY:1;skX:0;skY:0;","mask":"x:0px;y:0px;s:inherit;e:inherit;","to":"o:1;","ease":"Power4.easeInOut"},{"delay":"wait","speed":1000,"frame":"999","to":"y:[100%];","mask":"x:inherit;y:inherit;s:inherit;e:inherit;","ease":"Power2.easeInOut"}]' data-textAlign="['left','left','left','left']" data-paddingtop="[10,10,10,10]" data-paddingright="[0,0,0,0]" data-paddingbottom="[10,10,10,10]" data-paddingleft="[0,0,0,0]" style="z-index: 5; white-space: nowrap; font-size: 50px; line-height: 46px; font-weight: 700;font-family:Montserrat;">NIKMATI PENGALAMAN BARU </div>

						<!-- LAYER NR. 7 -->
						<div class="tp-caption NotGeneric-SubTitle   tp-resizeme rs-parallaxlevel-2" id="slide-141-layer-4" data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']" data-y="['middle','middle','middle','middle']" data-voffset="['52','52','52','51']" data-fontweight="['400','500','500','500']" data-width="none" data-height="none" data-whitespace="nowrap" data-type="text" data-responsive_offset="on" data-frames='[{"delay":1500,"speed":2000,"frame":"0","from":"y:[100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;opacity:0;","mask":"x:0px;y:[100%];s:inherit;e:inherit;","to":"o:1;","ease":"Power4.easeInOut"},{"delay":"wait","speed":1000,"frame":"999","to":"y:[100%];","mask":"x:inherit;y:inherit;s:inherit;e:inherit;","ease":"Power2.easeInOut"}]' data-textAlign="['left','left','left','left']" data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]" style="z-index: 6; white-space: nowrap; font-weight: 400;font-family:Montserrat;">KOTA YANG TIDAK MEMBEDAKAN KEBERAGAMAN AGAMA</div>
			...
			<div class="row">
                <div class="col-md-5 col-sm-6 hidden-xs">
                    ...
                    <div class="main_title">
                        <h2>Singkat Tentang <br><span>Palembang</span></h2>
						--------------------------------
                        <p>Kota Tertua di Indonesia</p>
                    </div>
                </div>
				<div class="col-md-7 col-sm-6">
                    <p>Kota Palembang adalah ibu kota provinsi Sumatera Selatan. Palembang adalah kota terbesar kedua di Sumatera setelah Medan. Kota Palembang memiliki luas wilayah 358,55 km²[4] yang dihuni 1,8 juta orang dengan kepadatan penduduk 4.800 per km². Diprediksikan pada tahun 2030 mendatang kota ini akan dihuni 2,5 Juta orang. Pembangunan LRT (kereta api layang), dan rencana pembangunan sirkuit motor GP di kawasan Jakabaring dan sirkuit F1 di kawasan Tanjung Api-Api, merupakan proyek pengembangan Kota Palembang terkini.
                    </br></br>Sejarah Palembang yang pernah menjadi ibu kota kerajaan bahari Buddha terbesar di Asia Tenggara pada saat itu, Kerajaan Sriwijaya, yang mendominasi Nusantara dan Semenanjung Malaya pada abad ke-9 juga membuat kota ini dikenal dengan julukan "Bumi Sriwijaya". Berdasarkan prasasti Kedukan Bukit yang ditemukan di Bukit Siguntang sebelah barat Kota Palembang yang menyatakan pembentukan sebuah wanua yang ditafsirkan sebagai kota pada tanggal 16 Juni 688 Masehi menjadikan kota Palembang sebagai kota tertua di Indonesia. Di dunia Barat, kota Palembang juga dijuluki Venice of the East ("Venesia dari Timur"). Saat ini Wali Kota Palembang dijabat oleh H. Harnojoyo, S.Sos. [5]</p>
                    <p class="text-center add_bottom_30">
                        <a href="all_tours_list.html" class="btn_1 medium"><i class="icon-eye-7"></i>Selengkapnya >></a>
                    </p>
                </div>
			</div>
			<!-- End row -->			
        ...
        <div class="container margin_60">
            ...
            <div class="main_title">
                ...
                <p>Tempat wisata ini paling paling digemari pengunjung selama berada di Kota Palembang</p>
            </div>
            ...
            <div class="row">
                    ...
                    <div class="tour_container">
                        ...
                        <div class="img_container">
                            <a href="single_tour.html">
                                <img src="img/new/rekomendasi1-ampera.jpg" class="img-responsive" alt="image">
                                <div class="short_info">
                                    <i class="icon_set_1_icon-44"></i>Bangunan Bersejarah
                                </div>
                            </a>
                        </div>
                        <div class="tour_title">
                            <h3><strong>Jembatan Ampera</strong></h3>
                            <div class="rating">
                ...
                <div class="col-md-4 col-sm-6 wow zoomIn" data-wow-delay="0.2s">
                    <div class="tour_container">
                        ...
                        <div class="img_container">
                            <a href="single_tour.html">
                                <img src="img/new/rekomendasi2-masjidagung.jpg" width="800" height="533" class="img-responsive" alt="image">
                                <div class="short_info">
                                    <i class="icon_set_1_icon-43"></i>Religi
                                </div>
                            </a>
                        </div>
                        <div class="tour_title">
                            <h3><strong>Masjid Agung</strong></h3>
                            <div class="rating">
                                <i class="icon-smile voted"></i><i class="icon-smile voted"></i><i class="icon-smile voted"></i><i class="icon-smile voted"></i><i class="icon-smile"></i><small>(75)</small>
                            </div>
                            <!-- end rating -->
                ...
                <div class="col-md-4 col-sm-6 wow zoomIn" data-wow-delay="0.3s">
                    <div class="tour_container">
                        ...
                        <div class="img_container">
                            <a href="single_tour.html">
                                <img src="img/new/rekomendasi3-kampungalmunawwar.jpg" width="800" height="533" class="img-responsive" alt="image">
                                <div class="short_info">
                                    <i class="icon_set_1_icon-44"></i>Wisata Lokal
                                </div>
                            </a>
                        </div>
                        <div class="tour_title">
                            <h3><strong>Kampung Al-Munawwar</strong></h3>
                            <div class="rating">
                                <i class="icon-smile voted"></i><i class="icon-smile voted"></i><i class="icon-smile voted"></i><i class="icon-smile voted"></i><i class="icon-smile"></i><small>(75)</small>
                            </div>
                            <!-- end rating -->
                ...
                <div class="col-md-4 col-sm-6 wow zoomIn" data-wow-delay="0.4s">
                    <div class="tour_container">
                        <div class="ribbon_3"><span>Populer</span></div>
                        <div class="img_container">
                            <a href="single_tour.html">
                                <img src="img/new/rekomendasi4-pulaukemaro.jpg" width="800" height="533" class="img-responsive" alt="image">
                                <div class="short_info">
                                    <i class="icon_set_1_icon-30"></i>Rekreasi & Sejarah
                                </div>
                            </a>
                        </div>
                        <div class="tour_title">
                            <h3><strong>Pulau Kemaro</strong></h3>
                            <div class="rating">
                                <i class="icon-smile voted"></i><i class="icon-smile voted"></i><i class="icon-smile voted"></i><i class="icon-smile voted"></i><i class="icon-smile"></i><small>(75)</small>
                            </div>
                            <!-- end rating -->
                ...
                <div class="col-md-4 col-sm-6 wow zoomIn" data-wow-delay="0.5s">
                    <div class="tour_container">
                        ...
                        <div class="img_container">
                            <a href="single_tour.html">
                                <img src="img/new/rekomendasi5-gelorasriwijaya.jpg" width="800" height="533" class="img-responsive" alt="image">
                                <div class="short_info">
                                    <i class="icon_set_1_icon-28"></i>Olahraga
                                </div>
                            </a>
                        </div>
                        <div class="tour_title">
                            <h3><strong>Gelora Sriwijaya</strong></h3>
                            <div class="rating">
                                <i class="icon-smile voted"></i><i class="icon-smile voted"></i><i class="icon-smile voted"></i><i class="icon-smile voted"></i><i class="icon-smile"></i><small>(75)</small>
                            </div>
                            <!-- end rating -->
                ...
                <div class="col-md-4 col-sm-6 wow zoomIn" data-wow-delay="0.6s">
                    <div class="tour_container">
                        ...
                        <div class="img_container">
                            <a href="single_tour.html">
                                <img src="img/new/rekomendasi6-pempek.jpg" width="800" height="533" class="img-responsive" alt="image">
                                <div class="short_info">
                                    <i class="icon_set_1_icon-44"></i>Kuliner Khas
                                </div>
                            </a>
                        </div>
                        <div class="tour_title">
                            <h3><strong>Pempek Palembang</strong></h3>
                            <div class="rating">
                                <i class="icon-smile voted"></i><i class="icon-smile voted"></i><i class="icon-smile voted"></i><i class="icon-smile voted"></i><i class="icon-smile"></i><small>(75)</small>
                            </div>
                            <!-- end rating -->
            ...
            <!-- End row -->
            <p class="text-center add_bottom_30">
                <a href="all_tours_list.html" class="btn_1 medium"><i class="icon-eye-7"></i>Lihat semua</a>
            </p>
		...
		<div class="main_title">
            <h2>Peta<span>Wisata</span></h2>
			<p>Lihat dan lakukan banyak hal selama di bersejarah ini</p>
        </div>
        <div id="map" class="map"></div>
		<!-- End container -->
        <div class="container margin_60">
            <div class="banner colored add_bottom_30">
                <h4><span>Jelajahi lebih jauh</span></h4>
                <p>
                    Apa yang bisa Kamu lihat dan lakukan selama di Kota Tertua di Indonesia ini?
                </p>
                <a href="#" class="btn_1 white">Lihat Peta Lebih Dekat</a>
            </div>
            <div class="main_title">
        ...
        <section class="promo_full">
			<div class="promo_full_wp magnific">
				<div>
					<h3>Video</h3>					
					<a href="https://youtu.be/yWzWg0agFIE" class="video"><i class="icon-play-circled2-1"></i></a>
				</div>
			</div>
		</section>
	</main>
