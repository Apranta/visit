<?php include 'header.php' ?>
	<main>
			...
			<div class="row">
                <div class="col-md-5 col-sm-6 hidden-xs">
                    ...
                    <div class="main_title">
                        <h2>Singkat Tentang <br><span>Kota Tertua</span> Di Indonesia</h2>
                        <p>Lorem Ipsum blablablalba</p>
                    </div>
                </div>
        ...
        <div class="container margin_60">
            ...
            <div class="main_title">
                <h2>Rekomendasi <span>Berwisata</span> Menyenangkan</h2>
            ...
            <!-- End row -->
            <p class="text-center add_bottom_30">
                <a href="all_tours_list.html" class="btn_1 medium"><i class="icon-eye-7"></i>View all</a>
            </p>
