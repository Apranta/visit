	...
	<main>
		...
		<div class="container margin_60">
			<div class="main_title">
                <h2><span>Coming Soon Events</span></h2>
            </div>
            <div class="row">
            	<div class="col-md-6">
							...
							<div class="col-lg-4 col-md-4 col-sm-4">
								<div class="img_list">
									<a href="single_tour.html">
										...
										<div class="short_info" align="center"><h4 style="color: white;">17 Jan 2017</h4></div>
									</a>
								</div>
							</div>
							...
							<div class="col-lg-8 col-md-6 col-sm-6">
								<div class="tour_list_desc">
									...
									<div class="pull-right">
										<div class="tooltip_styled tooltip-effect-4">
											<a href="single-event.php" class="btn_1">Details</a>
										</div>
									</div>
								</div>
							</div>
			...
			<div class="row">
				<aside class="col-lg-3 col-md-3">
						...
						<div class="collapse in" id="collapseFilters">
							<div class="filter_type">
								...
								<ul>
									<li>
										<label>
											<input type="checkbox" checked>January</label>
									</li>
									<li>
										<label>
											<input type="checkbox">February</label>
									</li>
									<li>
										<label>
											<input type="checkbox">Maret</label>
									</li>
									<li>
										<label>
											<input type="checkbox">April</label>
									</li>
									<li>
										<label>
											<input type="checkbox">Mei</label>
									</li>
									<li>
										<label>
											<input type="checkbox">June</label>
									</li>
									<li>
										<label>
											<input type="checkbox">July</label>
									</li>
									<li>
										<label>
											<input type="checkbox">Agustus</label>
									</li>
									<li>
										<label>
											<input type="checkbox">September</label>
									</li>
									<li>
										<label>
											<input type="checkbox">Oktober</label>
									</li>
									<li>
										<label>
											<input type="checkbox">November</label>
									</li>
									<li>
										<label>
											<input type="checkbox">Desember</label>
									</li>
								</ul>
							</div>
							<div class="filter_type">
								...
								<ul>
									...
									<li>
										<label>
											<input type="checkbox">Goverment</label>
									</li>
								</ul>
							</div>
						</div>
					...
					<div class="box_style_2">
						...
						<a href="tel://004542344599" class="phone">+628 8181818</a>
						...
						<div class="row">
							...
							<div class="col-lg-2 col-md-2 col-sm-2">
								<div class="price_list">
									<div>
										<h4 >17 Jan 2017</h4>
										<p><a href="single-event.php" class="btn_1">Details</a>
										</p>
									</div>
