...
<head>
    ...
    <link href="ayoshare/ayoshare.css" rel="stylesheet">
...
<![endif]-->
    ...
    <header>
        <div id="top_line">
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-sm-6 col-xs-6"><i class="icon-phone"></i><strong>+628 xxxxxxxx</strong></div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3 col-sm-3 col-xs-3">
                    <div id="logo_home">
                    	<h1><a href="index.html" title="City tours travel template">Kujungi Palembang</a></h1>
                    </div>
                </div>
